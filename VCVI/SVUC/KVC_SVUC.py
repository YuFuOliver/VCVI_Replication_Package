...
class KVC_SVUC:
    ...
    def __init__(self, d, is_vc, isYJ, block_size, optimizer, sampling, 
    ...
    def sample(self) -> Tuple[TensorWithGrad, TensorWithGrad, torch.Tensor]:
        ...
        theta,C,dlogdetC_dtau = KVC_SVUC.reptrick(self.tau, self.b, self.nu, L, yj, self.d, self.isYJ)
    ...
    def train(self, num_iter=10000):
        ...
        if self.sampling:
            ...
            for i in range(sample_size):
                theta = KVC_SVUC.reptrick(avg_tau,avg_b,avg_nu,L,yj,self.d,self.isYJ)
